...
| Approved work outstanding | **Track A**: A7, A8, A10, A11b, A12, **A13** (A1–A6, A9 and A11a done, all merged with reachability proven. **W1-44 is closed by A9.** A7 is held SERIAL behind A9: `safety` readiness requires `training_limitations`, whose staleness semantics A7 changes, which would change when A9's realignment is permitted to succeed). **Track B** (WAVE-1 survivors): W1-11, W1-13, W1-14, W1-15, W1-16, W1-18, W1-20, W1-21, W1-22, W1-23. |
